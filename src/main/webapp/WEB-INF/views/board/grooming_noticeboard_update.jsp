    ...
    <div class="container-fluid">
      <div class="box_general padding_bottom" >
         ...
         <div class="header_box version_2">
            <h2><i class="fa fa-file"></i>공지사항수정</h2>
         </div>
            <!-- 제목-->
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="form-group">
                  <label>제 목</label>
                  <input type="text" class="form-control" name="nt_title" value="${inform.nt_title }">
               </div>
            </div>   
         </div>
         <!-- 내용-->
         <div class="row">
            <div class="col-md-12">
               <div class="form-group">
                  <label>내 용</label>
                  <textarea class="editor" name="nt_con"><c:out value="${inform.nt_con } "/></textarea>
               </div>
            </div>
         </div>
      <input type="submit" value="수정" class="btn_1 medium" />
         </form>
      </div>
      <!-- /box_general-->
      <!-- /box_general-->
