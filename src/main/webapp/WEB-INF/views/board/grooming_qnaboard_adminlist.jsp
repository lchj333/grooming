...
<!-- contents -->
	...
	<form action="#" id="gr_noticeboard_list_form">
		<div id="grooming_qnaboard_customl\ist_div">
			<div id="grooming_qnaboard_customlist_section">
				<div id="grooming_qnaboard_customlist_articlelist">
					<div id="grooming_qnaboard_customlist_maintitle"></div>
					<div id="grooming_qnaboard_customlist_tablediv">
					<c:forEach var="a" items="${list }">
						<div id="grooming_qnaboard_customlist_tr">
							<div class="grooming_qnaboard_customlist_td" id="grooming_qnaboard_customlist_td1"><a href="inquiryDetail?in_num=${a.in_num }">${a.in_title }</a></div>
		...
		<!-- 페이징처리 끝 -->		
				...
				<a href="noticeInsert"><input type="button" value="문의하기" class="btn_1 medium" /></a>
				</c:if>
			--%>
			</div>
		</div> 
