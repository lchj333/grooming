					...
					<div class="container" >
						<form name="frm">
							...
							<div role="tablist" class="add_bottom_30 accordion_2" id="tips">
								<!-- card div start  cade 1(필수)서비스 이용약관  -->
								<div class="card">
									<!-- heder -->
									...
									<div id="collapseOne_tips" class="collapse" role="tabpanel"
										...
										<div class="card-body">
											...
											<p>개인정보 제공동의 1. 회사는 이용자의 동의가 있거나 관련법령의 규정에 의한 경우를 제외하고는
												...
												이용자의 개인정보 관리 및 보다 다양한 서비스 제공을 위하여 이용자의 별도 동의를 얻어 다음과 같이
												개인정보를 제공합니다. 제공받는 자 제공 목적 제공하는 개인정보 항목 보유 및 이용기간 Facebook
												페이스북 맞춤 타겟(Custom Audiences) 마케팅 이메일, 휴대폰 번호 페이스북 캠페인 대상선정
												이후 14일 3. 다만, 다음 각 호의 경우는 이용자의 별도 동의 없이 제공될 수 있습니다. - 서비스
												제공에 따른 요금정산을 위하여 필요한 경우 - 통계작성, 학술연구 또는 시장조사를 위하여 필요한 경우로서
												특정 개인을 알아볼 수 없는 형태로 가공하여 연구단체, 설문조사, 리서치 기관 등에 제공하는 경우 -
												개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 통신비밀보호법, 국세기본법, 금융실명거래
												및 비밀보장에 관한 법률, 신용정보의 이용 및 보호에 관한 법률, 전기통신기본법, 전기통신사업법, 지방세법,
												소비자보호법, 형사소송법 등 법률상 특별한 규정이 있는 경우 4. 이용자는 제3자에 대한 개인정보 제공
												동의를 거부할 수 있으며, 동의를 거부할 때에는 제3자 제공에 따른 서비스 이용에 제한을 받을 수 있습니다.
												5. 회사는 개인정보를 국외의 제3자에게 제공할 때에는 이용자에게 내용을 알리고 동의를 받습니다.</p>
								...
								<div class="card">
									...
									<!-- card div  detail-->
									<div id="collapseTwo_tips" class="collapse" role="tabpanel"
										data-parent="#tips">
										<div class="card-body">
								...
								<div class="card">
									...
									<!-- card div  detail-->
									<div id="collapseThree_tips" class="collapse" role="tabpanel"
										data-parent="#tips">
										<div class="card-body">
