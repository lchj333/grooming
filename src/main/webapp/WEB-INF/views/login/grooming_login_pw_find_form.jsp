...
<script type="text/javascript">
	$(document).ready(function(){
	  ...
	  $("#findPw").on('click', function(){
		...
		document.frm.action = "mb_pw_findOk";
			...
			<figure>
			  ...
			  <form name="frm">
				<div class="access_social" style="text-align: center;">
					<h4 style="font-weight: 600;">비밀번호 찾기</h4>
					<h6>아이디와 이메일을 인증해주세요</h6>
				</div>
				<div class="divider"></div>
				<div class="form-group">
					<label>아이디</label>

					<input type="text" class="form-control" name="mb_id" id="mb_id" value="${id }"/>
				</div>
				<div class="form-group">
					<label>이메일</label>
				...
				<input type="button" value="비밀번호 찾기" class="btn_1 rounded full-width" id="findPw"/>
